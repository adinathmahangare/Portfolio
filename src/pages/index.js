      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className='w-1/2 pr-5 md:w-full md:pr-10'>
              <Image src={profilePic} alt="Adinath" className='w-full h-auto lg:hidden md:inline-block md:w-full ' priority
                sizes="(max-width: 768px) 100vw,(max-width: 1200px) 50vw, 50vw" />
            </div>
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>

              <AnimatedText text="Building the Brighter Future, One Line at a Time"
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/Adinath_Mahangare.pdf" target="_blank"
                ...
                <Link href="mailto:adimahangare914@gmail.com" target={'_blank'} className='ml-4 lext-lg font-medium capitalize text-dark underline dark:text-light md:text-base'>Contact</Link>
              </div>
